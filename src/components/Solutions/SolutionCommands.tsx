...
interface SolutionsCommandsProps {
  regenerateProblemStatement: () => void
  regenerateSolution: () => void
  isProcessing: boolean
  extraScreenshots: Screenshot[]
}

const SolutionsCommands: React.FC<SolutionsCommandsProps> = ({
  ...
  const handleRegenerateProblemStatement = () => {
    regenerateProblemStatement()
  }
...
export default SolutionsCommands
